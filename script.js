...
function ageBtn() {
    ...
    if (age >= 18) {
        ...
        ageResult.textContent = `Sorry! You can't vote, you age falls between 10 and 16 `
    } else if (age < 10 && age >= 5) {
        console.log(`Citizen's age is between 9-5`);
        ageResult.textContent = `Sorry! Your age is too low, you age falls between 9 and 5`
    } else if (age < 5 && age >= 0) {
        console.log(`Citizen's age is below 5`);
        ageResult.textContent = `Not really! You can't vote, you age is below 5`
    } else if (age == 0) {
        console.log(`Citizen's input 0`);
        ageResult.textContent = `Error! You can't just be born now (your age can't be 0)`
    } else {
        console.log(`Citizen's input negative number`);
        ageResult.textContent = `Error! You can't input negative number`
    }
}